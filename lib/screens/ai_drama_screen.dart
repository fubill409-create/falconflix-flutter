...
class AiDramaScreen extends StatelessWidget {
          ...
          SafeArea(
            ...
            child: ListView(
              ...
              children: [
                ...
                _featured(context),         // ② 样板剧《最后一通电话》（demo，免费试玩）
  ...
  Widget _featured(BuildContext context) {
    return Bounce(
      ...
      child: Container(
        ...
        child: ClipRRect(
          ...
          child: Stack(
            fit: StackFit.expand,
            children: [
              // 海报背景图（image2.0 生成的真海报）
              CachedNetworkImage(
                imageUrl: '$_kPosterBase/lastcall.png',
                fit: BoxFit.cover,
                placeholder: (_, __) => Container(
                  decoration: const BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Color(0xFF3A1450), Color(0xFF7A1E4E)],
              ...
              const DecoratedBox(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [Color(0x66000000), Colors.transparent, Color(0xDD000000)],
                    stops: [0, 0.4, 1],
                  ),
                ),
              ),
              Positioned(
                left: 14,
                top: 14,
                child: _statusBadge(AppLocalizations.of(context).aid_demoBadge,
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(AppLocalizations.of(context).aid_lastcallSub,
                      style: TextStyle(
      ...
      ).animate(delay: 80.ms).fadeIn(duration: 600.ms).slideY(
...
class _NovaCardState extends State<_NovaCard> {
  ...
  String _mainTitle() {
    final t = item.title;
    final i = t.indexOf('/');
    final base = i > 0 ? t.substring(0, i) : t;
  ...
  String _subTitle(BuildContext context) {
    final t = item.title;
    final i = t.indexOf('/');
    if (i < 0) return AppLocalizations.of(context).aid_fallbackHook;
    return t.substring(i + 1).replaceAll(RegExp(r'（[^）]*）'), '').trim();
  }
